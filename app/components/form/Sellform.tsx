...
export function SellForm(){
    ...
    return(
        ...
        <CardHeader>
            <CardTitle>Sell Your Prodduct with ease</CardTitle>
            <CardDescription> Please describe your product in detail so that it can be sold </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col gap-y-10">
            ...
            <div className="flex flex-col gap-y-2">
                ...
                <UploadDropzone onClientUploadComplete={(res)=>{
                    ...
                    toast.success("Your zip file have been uploaded")
                }}
