...
export function SettingsForm({email,firstName,lastName} : iAppProps){
    ...
    return(
        ...
        <CardHeader>
            ...
            <CardDescription>Here you will find settings regarding your acount </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col gap-y-5">
           ...
           <div className=" flex flex-col gap-y-2">
            ...
            <div className=" flex flex-col gap-y-2">
                <Label>Email</Label>
                <Input name="email" type="email" disabled defaultValue={"luri@gmail.com"}/>
            </div>

        </CardContent>
        <CardFooter>
           <Submitbutton title="Update your setting" />
        </CardFooter>
